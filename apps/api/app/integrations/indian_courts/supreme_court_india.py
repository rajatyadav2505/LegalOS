...
class SupremeCourtIndiaConnector(BaseCourtConnector):
    source_system = SourceSystem.SUPREME_COURT_INDIA

    def supports(self, artifact_kind: ArtifactKind, content_type: str, text: str) -> bool:
        return 'data-legalos-source="supreme-court-india"' in text
